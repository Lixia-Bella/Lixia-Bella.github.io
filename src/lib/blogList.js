...
export const loadBlogData = async () => {
	...
	const summaries = await Promise.all(
		posts.map(({ file, summary }) =>
			summary ? Promise.resolve(summary) : fetchPostSummaryViaFetch(file)
		)
	);
...
export const getFallbackPosts = () => [
	...
	},
	{
		...
		author: 'Bella',
		summary:
			'系统梳理 CSS Flexbox 和 Grid 两大布局方案的核心概念与常用属性，通过实际案例对比两者的适用场景。',
	...
	},
	{
		...
		author: 'Bella',
		summary:
			'从零搭建前端开发环境，包括 VS Code 配置、Git 版本控制、EditorConfig 统一编码风格、Prettier 代码格式化等。',
		tags: ['工具链', '开发环境', 'Git'],
		file: '20260316',
		icon: 'fa-tools',
	},
