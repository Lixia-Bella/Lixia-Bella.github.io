...
let loadedListenerBound = false;

/**
 * 页面加载完成后的初始化
 */
export const initLoadedState = () => {
    if (loadedListenerBound) return;
    loadedListenerBound = true;

    window.addEventListener('load', () => {
        document.body.classList.add('loaded');
        console.log('%c欢迎来到阳光小站！', 'color: #C3B1E1; font-size: 20px; font-weight: bold;');
        console.log('%c愿你每天都充满阳光！', 'color: #F2A6B3; font-size: 14px;');
    });
};
