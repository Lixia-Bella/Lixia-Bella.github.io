        ...
        <main className="main-content">
            <section className="blog-list-section" id="blogListSection">
                ...
                <div className="blog-post-list">
                    ...
                    {!loading && loadError && (
                        <p className="blog-error-msg" style={{ textAlign: 'center', color: 'var(--text-secondary)' }}>
                                ...
                                <div className="blog-post-body">
                                    ...
                                    <div className="blog-post-footer">
                                        <div className="blog-post-tags">
                                            {tags.map((tag) => (
                                                <span key={tag} className="blog-tag" style={renderTagStyle(tag)}>
                                                    {tag}
                                                </span>
                                            ))}
                                        </div>
            ...
            <section className="quiz-entry-section">
                ...
                <div className="quiz-entry-card">
                    <div className="quiz-entry-info">
                        ...
                        <h3>边玩边学，挑战编程知识！</h3>
                        <p>
                            涵盖 Node.js、HTML/CSS、Web 开发、后端服务、大模型、算法、C/C++ 等多领域知识。 通关赢积分，积分兑好礼！
                        </p>
            ...
            <section className="links-section">
                ...
                <div className="links-grid" style={{ display: 'flex', gap: '20px', justifyContent: 'center', flexWrap: 'wrap' }}>
                    <div className="link-card">
                        <a href="https://Lixia-Bella.github.io/" target="_blank" rel="noreferrer" className="external-link">
